...
# paste here the encrypted code you got from ie_exfile.py (and that should have been posted to Tumblr as well)
...
plaintext = zlib.deccompress(decrypted)
print(plaintext)
