...
print("device1 remooved blanks using replace:\n  ", device1)
...
print("\n\nSEPARATING VESION STRING COMPONENTS")
...
GigabitEthernet2
        Switching path      pkts In  Chars In  Pkts Out  Chars Out
           ...
           Route cache            0         0         0          0
     Distributed cache         6097    663304         0          0
...
Internet 10.10.20.254          0   0896.ab9e.444c  ARPA  GigabitEthernet1
"""
arp_table = dict()
