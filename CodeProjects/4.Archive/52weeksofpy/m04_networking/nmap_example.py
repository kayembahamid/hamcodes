...
while True:
    ...
    scan_output_2 = nm.scan_result['scan'][ip] # this is what __getitem__ returns
...
# print("\nScaning all hosts in subnst using port 22")
# nm.scan("192.168.256.0/24", arguments="-p 22 --open")
