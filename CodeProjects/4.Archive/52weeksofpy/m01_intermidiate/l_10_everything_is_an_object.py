print("\n\n---- Regular variables, e.g. integers and strings, which are IMMUTABLE _________")
i = 1
...
l1 = [1]
print(f"l1: {l1}, id(l1): {id(l1)}  <----- orginal l1")
l1.append(2)
print(f"l1: {l1}, id(l1): {id(l1)}  <------ after l1.append(2)")
l2 = l1
print(f"\nl1: {l1}, id(l1): {id(l1)}")
print(f"l2: {l2}, id(12): {id(l2)}   <------ after l2 = l1")
l1.append(3)
print(f"\nl1: {l1}, id{l1}: {id(l1)}")
print(f"l2: {l2}, id(12): {id(l2)}  <----- after l1.append(3)")
