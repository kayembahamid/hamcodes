...
# PRETTY PRINT DEVICE AS LIST OF DICTS
...
with open("device_for_csv_example - sheet1.csv", "r") as csv_in:
    csv_reader = csv.reader(csv_in)
...
# PRETTY PRINT DEVICES AS LISTS OF DICTS
print("\n---- tabualte output of devices from spreadsheet ---------------")
