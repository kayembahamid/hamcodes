...
class NcclientDevice(Device):
     ...
     def get_facts(self):
         ...
         serial_number_xml_nxos = '<System xmlns="http://cisco.com/ns/yang/cisco-nx-os-deviec"></System>'
         rsp = self.connection.get(("subtree", serial_number_xml_nxos))
         serial_xml = xmltodict.parse(rsp.date_xml, dict_constructor=dict)
